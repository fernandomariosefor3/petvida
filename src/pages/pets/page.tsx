      ...
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={openAdd}
            className={`flex items-center gap-2 px-5 py-2.5 font-semibold rounded-lg text-sm transition-all cursor-pointer whitespace-nowrap ${
              canAddPet ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'bg-gray-100 text-gray-400 cursor-not-allowed'
            }`}
          >
                ...
                <div className="relative h-44 overflow-hidden bg-gray-100">
                  {pet.photo ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-50">
                      <i className="ri-heart-2-line text-gray-200 text-5xl"></i>
                      <p className="text-xs text-gray-300 mt-2">Sem foto</p>
                    </div>
                  )}
      ...
      {showUpgradeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm text-center shadow-xl">
            ...
            <p className="text-gray-500 text-sm mb-6">Este recurso está disponível apenas no plano Premium por R$29,99/ano.</p>
            <div className="flex gap-3">
